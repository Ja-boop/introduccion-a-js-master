...
// Escribí código para que acepte 2 argumentos (numero1 y u)
...
//let anioActual = 2019;
//let anioDeNacimiento = 2000;

//let miEdad = restar(anioActual, anioDeNacimiento);
...
//const anioDeNacimiento = prompt("¿En que año naciste?")

//console.log("Tu edad es de " + (calcularEdadUsuario(anioActual, anioDeNacimiento))); 
...
salarioAnual = Number (prompt("¿Cuanto ganas al año?")); 

console.log("Tu salario mensual es de: " + (calcularSalarioMensual(salarioAnual)));
console.log("Tu salario semanal es de: " + (calcularSalarioMensual(salarioAnual / 4)));
console.log("Tu salario diario es de: " + (calcularSalarioMensual(salarioAnual / 4 / 7)));
console.log("Tu salario por horas es de: " + (calcularSalarioMensual(salarioAnual / 4 / 7 / 24)));
console.log("Tu salario por minutos es de: " + (calcularSalarioMensual(salarioAnual / 4 / 7 / 24 / 60)));
...
/*let operador = prompt("¿Cual es la operacion?");
const numero1 = Number (prompt("Elegi un numero1"));
const numero2 = Number (prompt("Elegi un numero2"));
let resultado;
